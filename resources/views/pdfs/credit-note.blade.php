...
<head>
    <meta charset="utf-8">
    <title>Nota Crédito {{ $creditNote->prefix }}-{{ $creditNote->number }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="document-info">
            <h1>NOTA CRÉDITO</h1>
            <p>No. {{ $creditNote->prefix }}-{{ $creditNote->number }}</p>
            <p>Fecha: {{ $creditNote->issue_date->format('Y-m-d') }}</p>
            <p>CUFE: {{ $creditNote->cufe }}</p>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="invoice-info">
        ...
        <p>No. {{ $creditNote->invoice->prefix }}-{{ $creditNote->invoice->number }}</p>
        <p>Concepto de Corrección: {{ $creditNote->correction_concept }}</p>
        <p>Notas: {{ $creditNote->notes }}</p>
    </div>
    ...
    <div class="footer">
        <p>Esta nota crédito es un título valor según el artículo 772 del Código de Comercio</p>
